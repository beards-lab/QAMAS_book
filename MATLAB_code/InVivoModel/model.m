function [dXdt,J] = model(t, X, activity_array, solve_ode, Cr_tot_c)
...
X_CK  = activity_array(9);
X_AtC = activity_array(10); 
...
% Gibbs energy (J mol^(-1))
DrGo_CK = - R * T * log(Keq_CK);
DrGapp_CK = DrGo_CK + R * T * log(PADP_c / (PATP_c * H_c)) ; 
